...
def parse_args():
    ...
    parser.add_argument("--root", default="media/asghar/media/NUSCENES_DATASET_ROOT/")
    parser.add_argument("--txt_result",type=bool, default=False,help="whether to save results to standard KITTI format of txt type",)
    parser.add_argument(
        "--gpus",
        type=int,
        default=1,
