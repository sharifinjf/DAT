...
class DetectionBox(EvalBox):
    ...
    def __init__(self,
        ...
        super().__init__(sample_token, translation, size, rotation, velocity,velocity0,acceleration, ego_translation, num_pts)
    ...
    def __eq__(self, other):
        return (self.sample_token == other.sample_token and
                ...
                self.velocity0 == other.velocity and
    ...
    def deserialize(cls, content: dict):
        ...
        return cls(sample_token=content['sample_token'],
                   ...
                   velocity0=tuple(content['velocity0']),
                   acceleration=tuple(content['acceleration']),
    ...
    @classmethod
    def deserializeFutreDet(cls, content: dict):
        """ Initialize from serialized content. """
        return cls(sample_token=content['sample_token'],
                   translation=tuple(content['translation']),
                   size=tuple(content['size']),
